        ...
        <section className="promotions bgGrey">
            <div className="container">
                ...
                <div className="promotionItem">
                    ...
                    <div className="text">
                        <h4>Кешбек</h4>
                        <p>При замовленні піци , Ви отримуєте бонусні бали, за які ви можите придбати будь-яку піцу. <span>Бонуси нараховуються тільки для зареєстрованих користувачів</span></p>
                    </div>
                </div>
                <div className="promotionItem">
